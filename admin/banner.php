                          ...
                          <div class="row">
                            ...
                            <?php
                              ...
                              <div style="width: fit-content;" class="portfolio-thumb in">
                                  <img class="img-responsive img-center" src="./admin_users_images/<?= $row['image'] ?>" width="300px" alt="">
                                  <span class="project-title">Banner</span>
                                  <span class="overlay-mask"></span>
                                <a class="link centered" href="manage_banner.php?id=<?= $row['id'] ?>"><i class="fa fa-pencil-alt fa-fw"></i></a>
                              </div>
                              <?php
                                 }
                                 ?>
