	 ...
	 if($msg==''){
	   if(isset($_GET['id']) && $_GET['id'] !=''){
		if($_FILES["image"]["name"]!=''){
			...
			$p_update = "update admin_user set name='$name',password='$password',email='$email',mobile='$mobile',role_id='$role_id',image='$image' where id='$_id'";
		}
		else{
			$p_update = "update admin_user set name='$name',password='$password',email='$email',mobile='$mobile',role_id='$role_id' where id='$_id'";
		}
