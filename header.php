  ...
  <body>
    ...
    >
      ...
      <div class="flex gap-4">
        <i
          id="menu-icon"
          class="fa-solid fa-bars sm:hidden block text-lg text-white cursor-pointer"
        ...
        <div class="relative w-full">
          ...
          />
          <i
            class="fas fa-search absolute right-3 top-1/2 transform -translate-y-1/2 text-black text-lg sm:text-xl"
          ></i>
        </div>
      </div>
      <!-- Logo Start -->
    ...
    >
      ...
      <ul
        class="flex flex-col sm:flex-row gap-4 sm:gap-10 text-white text-center py-3"
      >
        <!-- Shop -->
        ...
        <li>Link 5</li>
        <a href="#"
          ><li class="hover:underline hover:cursor-pointer">About</li></a
        >
        <a href="#"
          ><li class="hover:underline hover:cursor-pointer">Contact</li></a
        >
      </ul>
    </nav>
    <!-- Navbar End -->