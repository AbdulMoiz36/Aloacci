    ...
    <div class="bg-white p-10 rounded-lg shadow-lg w-5/6 md:w-2/3 lg:w-1/3 relative">
        ...
        <?php if (!isset($_SESSION['USER_LOGIN'])): ?>
            ...
            <?php else: ?>
                ...
                <div onclick="addToCartAndCheckout(currentProductId)" class="w-full p-3 mt-3 text-center border-2 hover:cursor-pointer bg-gradient-to-bl from-yellow-500 via-yellow-500 to-amber-600 shadow-sm hover:shadow-xl transition-shadow ease-in-out duration-300 font-semibold rounded-full text-white">Buy It Now</div>
